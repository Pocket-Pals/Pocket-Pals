...
export default function Game() {
  ...
  class sceneA extends Phaser.Scene {
    ...
    create() {
      ...
      healthText = this.add
        .text(20, 13, `Health: ${health}`, { fontSize: "16px", fill: "#000" })
        .setDepth(4);
      thirstText = this.add
        .text(20, 33, `Thirst: ${thirst}`, { fontSize: "16px", fill: "#000" })
        .setDepth(4);
      bowlText = this.add
        .text(20, 53, `Hunger: ${hunger}`, { fontSize: "16px", fill: "#000" })
        .setDepth(4);
      hygieneText = this.add
        .text(20, 73, `Hygiene: ${hygiene}`, { fontSize: "16px", fill: "#000" })
        .setDepth(4);
  ...
  class sceneB extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.spritesheet("raccoon", "/assets/character/raccoon.png", {
        frameWidth: 363,
        frameHeight: 295,
      });
