...
export function TutorialDiv({
  ...
  if (page >= "6") {
    text =
      "You're ready! You can always come back to this tutorial by clicking on the question mark in the top right corner.";
    page === 0;
    return (
      <div>
        <Typography
